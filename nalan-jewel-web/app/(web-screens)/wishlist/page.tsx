        ...
        <>
            ...
            <main className="mt-[8vh] pb-36 flex flex-col items-center select-none">
                ...
                {!isLoggedIn ? (
                    ...
                    >
                        <i className="material-icons text-6xl text-gray-300">favorite_border</i>
                        <h2 className="text-2xl font-semibold text-gray-800">Your Wishlist is Empty</h2>
                        <p className="text-gray-600">Browse our collection and add items you love to your wishlist</p>
                        <motion.div
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                        >
